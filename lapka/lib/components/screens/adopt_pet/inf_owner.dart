...
import 'package:lapka/components/basic/msg_owner_button.dart';
                        ...
                        Container(
                          child: Row(
                            children: [
                              ...
                              BasicText.body14Light((widget.number.toString()).replaceAllMapped(RegExp(r".{3}"), (match) => "${match.group(0)} ")),
                            ],
                          ),
                        ),
                        MsgOwnerButton(onPressed: () async {
                          // Android
                           String uri = 'sms:${widget.number.toString()}';
