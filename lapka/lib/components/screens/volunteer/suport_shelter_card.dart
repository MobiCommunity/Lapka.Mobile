        ...
        child: Column(
          ...
          children: [
            ...
            BasicText.body14Light(
              'Wybierz dowolną kwotę i wesprzyj nasze schronisko. Twoja wpłata pozwoli nam zakupić najpilniejsze rzeczy.',
              color: BasicColors.darkGrey.withOpacity(0.8),
            ),
            SizedBox(
              height: 14,
            ),
            BasicButton(
              onPressed: () {
                BasicDialog.showDialogCustom(context,
                    HelpDialog(accountNumber: '1122223333444455556666'));
              },
              text: "WESPRZYJ SCHRONISKO",
