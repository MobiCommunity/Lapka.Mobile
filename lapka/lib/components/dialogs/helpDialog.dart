        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(left: 20, right: 20, top: 26, bottom: 32),
                child: Column(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          BasicText.body14Light('Dziękujemy za to, że chcesz nam pomóc. To dużo dla nas znaczy. Aby móc zrealizować tę formę pomocy skontaktuj się z nami i się umów na dokładny termin pomocy.'),
                          ...
                          Padding(
                            ...
                            child: MsgOwnerButton(onPressed: () async {
                              // Android
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(child: BasicText.body14Light((accountNumber.toString()).replaceFirstMapped(RegExp(r".{2}"), (match) => "${match.group(0)} ").replaceAllMapped(RegExp(r"\d{4}"), (match) => "${match.group(0)} "), center: true,)),
                            InkWell(
                              onTap: () {
                                print('ravioli');
                                Clipboard.setData(ClipboardData(text: accountNumber));
                              },
                              child: SvgPicture.asset('lib/assets/copy-icon.svg'),
                            )
                          ],
                        ),
                      ),
